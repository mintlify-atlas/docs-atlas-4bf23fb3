...
description: "ETL Dinámico uses a clean four-layer architecture separating configuration, infrastructure, service logic, and the Streamlit UI to keep each concern isolated."
---
