...
description: "DataTransformer applies case conversion, date extraction, and column concatenation to Pandas DataFrames. Pure in-memory operations — no database calls."
---
