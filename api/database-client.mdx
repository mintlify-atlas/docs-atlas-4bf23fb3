...
description: "DatabaseClient manages SQLAlchemy engines for both OLTP and OLAP SQL Server databases, providing connection context managers and schema introspection methods."
---
