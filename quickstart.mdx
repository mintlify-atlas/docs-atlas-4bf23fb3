...
3. **Configure column mappings** — assign each source column a transformation type (`none`, `upper`, `lower`, `year`, `month`, `day`) and map it to a column in the destination table.
